...
async def run_test():
    ...
    try:
        ...
        # Locate a task in 'To Do' column and drag it to 'In Progress' column.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div[2]/main/div[2]/div/div[2]/div/div[2]/div/div[8]/div/div/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
